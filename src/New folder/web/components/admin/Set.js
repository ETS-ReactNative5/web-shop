      ...
      param = {
        updateQuery: {
          ...
          ChequeInfo: {
            ...
            MaxChequeMounth:this.state.MaxChequeMounth,
            ...
            <Panel header="تنظیمات سیستم" style={{ marginTop: 20, textAlign: 'right', marginBottom: 50, fontFamily: 'yekan' }}>
              <div className="row" >
                ...
                <div className="col-12" style={{ display: 'flex', alignItems: 'baseline' }}>
                  ...
                  <label style={{ paddingRight: 5, marginTop: 5 }}>ثبت نام از کاربران عمومی انجام شود</label>

                </div>
                }
                {this.state.System == "company" &&
                <div className="col-12" style={{ display: 'flex', alignItems: 'baseline' }}>
                  <Checkbox onChange={e => this.setState({ AllowSubSystem: e.checked })} checked={this.state.AllowSubSystem}></Checkbox>
                  <label style={{ paddingRight: 5, marginTop: 5 }}>امکان ثبت نام زیر سیستم وجود دارد</label>
                  ...
                  <Fieldset legend="درگاه فعال" className="yekan" style={{ fontFamily: 'yekan' }}>
                    ...
                    <div className="row">
                     ...
                     <div className="row">
                        ...
                        <div className="col-lg-3 col-12" style={{ display: 'flex', alignItems: 'end' }}>
                          <div className="group">
                            <input className="form-control yekan" autoComplete="off" type="text" value={this.state.MaxChequeMounth} name="MaxChequeMounth" onChange={(event) => this.setState({ MaxChequeMounth: event.target.value })} required="true" />
                            <label className="yekan">حداکثر ماه</label>
                          </div>

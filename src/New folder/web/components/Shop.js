...
class Shop extends React.Component {
        ...
        let SCallBack = function (response) {
            ...
            if (response.data.extra.shop) {
                ...
                that.setState({
                    ...
                    layout: response.data.result.length < 3 ? "list" : that.state.layout,
                    shop: shop,
                    ...
                    Time3: Time3,
                    Time4: Time4,
                    ShopIsOpen: !that.state.ProductBase ? extra.shop[0].Opened : true,
                    PeykInfo: PeykInfo,
        ...
        if (layout === 'grid' && car) {
            ...
            return (
                this.state.ProductBase ?
                    <Link className="col-12 col-lg-4 col-md-4 col-sm-6" style={{ textAlign: 'center', paddingRight: 0, paddingLeft: 0, paddingTop: 0, paddingBottom: 0 }} to={`${process.env.PUBLIC_URL}/products?id=${(car.product_detail && car.product_detail[0]) ? car.product_detail[0]._id : car._id}`} href="#" >
                    {
                        content
                    }
                    </Link>
            ...
            let pic = (car.fileUploaded && car.fileUploaded.split("public")[1]) ? this.state.absoluteUrl + car.fileUploaded.split("public")[1] : this.state.absoluteUrl + 'nophoto.png';
            let content = <div  style={{ textAlign: 'center', paddingRight: 0, paddingLeft: 0, paddingTop: 0, paddingBottom: 0 }}>
            ...
            return (
                this.state.ProductBase ?
                <Link className="col-12 col-lg-12 col-md-12 col-sm-12" to={`${process.env.PUBLIC_URL}/products?id=${(car.product_detail && car.product_detail[0]) ? car.product_detail[0]._id : car._id}`} >
                    {
                        content
                    }
    ...
    changeCatList(e) {
        ...
        this.setState({
            GridData: GridData,
            layout: GridData.length < 3 ? "list" : this.state.layout
        })
        //window.scrollTo(0, 0);
    }
    render() {
                ...
                {(this.state.shop && !this.state.loading) ?
                    <div className={this.state.Theme == "2" ? "B-container" : "A-container"}>
                        <div className="row justify-content-center firstInPage" style={{ direction: 'rtl', minHeight: 600 }}>
                            ...
                            <div className={this.state.Theme != "2" ? "col-lg-10 col-md-12" : "col-lg-12 col-md-12"}>
                                            ...
                                            <div className="col-12" >
                                                {
                                                    ...
                                                    <div>
                                                        ...
                                                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-evenly', border: '1px solid #eee', borderRadius: 5, padding: 5 }} >

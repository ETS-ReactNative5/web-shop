...
class Products extends React.Component {
        ...
        let SCallBack = function (response) {
            ...
            res.map((v, i) => {
                that.setState({
                    ...
                    desc: v.desc,
                    review: v.review,
                    specialReview: v.specialReview,
                    showSwipper:v.fileUploaded1 ? true : false,
                    ...
                    Time3: Time3,
                    Time4: Time4,
                    ShopIsOpen: !that.state.ProductBase ? extra.Seller[0].Opened : true,
                    InTime: !that.state.ProductBase ? ((Time1 <= extra.Time && extra.Time <= Time2) || (Time3 <= extra.Time && extra.Time <= Time4)) : true
                })
        ...
        axios.post(that.state.url + 'checktoken', {
            ...
            .then(response => {
                ...
                if (PeykInfo[2].subCity == PeykInfo[0].subCity)
                    ...
                    userLocation = 4;
                if (!this.state.ProductBase && ((userLocation == 4 && !PeykInfo[0].SendToCountry) || (userLocation == 3 && !PeykInfo[0].SendToState) || (userLocation == 2 && !PeykInfo[0].SendToNearCity) || (userLocation == 1 && !PeykInfo[0].SendToCity))) {
    ...
    getCartItems(PDId, PId, Number, UId, Price, Allow, CatId) {
        ...
        let SCallBack = function (response) {
            ...
            if (!SellerId) {
                that.toast.current.show({
                    severity: 'error', summary: 'عدم امکان خرید از چند فروشگاه', detail: <div>با توجه به محصولات موجود در سبد خرید شما در حال حاضر فقط می توانید از محصولات فروشگاه {sellerName} خرید کنید <br />
    ...
    render() {
        ...
        return (
            <div ref={this.myRef}>
                        ...
                        <div className="col-12" style={{ borderColor: '#ccc', marginTop: 10 }}>
                            <div className="row justify-content-center">
                                ...
                                <div className="col-3">
                                    <div style={{ cursor: 'pointer', textAlign: 'center', padding: 5 }} onClick={() => {
                                        this.setState({
                                            DialogPic: this.state.pic5
                                        })
                                    }} ><img src={this.state.pic5} name="pic5" style={{ height: 100, borderRadius: 12 }} alt="" />
                                    </div>
                                </div>
                ...
                {
                    !this.state.loading ?
                        <div className={this.state.Theme == "2" ? "single_product firstInPage B-container" : "single_product firstInPage A-container"} style={{ direction: 'rtl' }} >
                            ...
                            <div >
                                {!this.state.Haraj ?
                                    ...
                                    {this.state.Theme != "2" ?
                                        ...
                                        <div className="row" style={{ backgroundColor: '#fff', padding: 20 }} >


                                            <div className="col-lg-6 col-12 order-1 order-lg-2" style={{ borderLeft: '1px solid #eee' }}>
                                                <div className="product_description" style={{ textAlign: 'right' }}>
                                                    <div className="product_name YekanBakhFaBold" style={{ textAlign: 'right' }}>
                                                        <span style={{ borderBottom: "1px solid #eee" }}>{this.state.title}</span> <br /> <div style={{ fontSize: 14, marginTop: 15, color: '#b5b5b5' }}>{this.state.subtitle}</div></div>
                                                    ...
                                                    {this.state.Tags && (typeof this.state.Tags == "object") && this.state.Tags.length > 0 &&
                                                        <div style={{ marginTop: 20 }}>
                                                            ...
                                                            <div style={{ padding: 5, backgroundColor: '#fff', textAlign: 'right', borderRadius: 5, display: 'flex' }}>
                                                                {this.state.Tags.map((v, i) => {
                                                                    return (
                                                                        <div style={{ marginLeft: 10 }} severity="info" >
                                                                            <Link to={`${process.env.PUBLIC_URL}/Tag?tag=${v._id}`} style={{ textDecoration: 'none', color: '#333' }}>

                                                                                <span className="iranyekanwebmedium" style={{ color: '#0fabc6', fontSize: 15 }}  >{v.title}</span>
                                            ...
                                            <div className="col-lg-3 col-12 order-3 order-lg-3" >
                                                            ...
                                                            <form action="#">
                                                                ...
                                                                {this.state.MainShopInfo.length > 0 &&
                                                                    <div>
                                                                        ...
                                                                        <div className="product_text borderBottom" ><p className="YekanBakhFaBold" style={{ padding: "10px", textAlign: 'right' }}><i className="fal fa-box-open" style={{ fontSize: 21, color: 'green', paddingLeft: 7 }}></i>{this.state.TitlesMap["existInStore"]}</p></div>
                                                                    ...
                                                                    (this.state.UId || !this.state.ShowPriceAftLogin) ?
                                                                        <div className=" row" style={{ marginTop: 20 }}>
                                                                            ...
                                                                            <div className="button_container col-md-12 col-12 borderBottom " style={{ marginTop: 15 }}>
                                                                                ...
                                                                                <div >
                                                                                    <Button type="button" style={{ marginBottom: 10, paddingTop: 10, paddingBottom: 10, paddingRight: 10, paddingLeft: 10, width: '100%', background: '#ef394e', color: '#fff' }} className="iranyekanwebmedium" onClick={() => { this.SendToCart(this.state.id, this.state.ProductId, this.state.reqNumber, null, (this.roundPrice(this.state.price - ((this.state.price * ((!this.state.NoOff ? parseInt(this.props.off) : 0) + this.state.off)) / 100))), null, this.state.CatId) }}><span style={{ float: 'right' }} ><i style={{ fontSize: 25 }} className="fal fa-shopping-cart" /></span>  <span>انتقال به سبد خرید</span></Button>
                                            ...
                                            {(this.state.pic1 != "" && this.state.showSwipper ) ?
                                            ...
                                            <div className="col-lg-3 col-8 order-lg-1 order-2 d-md-block d-none" style={{ borderLeft: '1px solid #eee' }}>
                                                <div className="row" >
                                                    ...
                                                    {(this.state.pic2.indexOf("nophoto.png") < 0 || this.state.pic3.indexOf("nophoto.png") < 0 || this.state.pic4.indexOf("nophoto.png") < 0) &&
                                                        <div >
                                                            <ul className="image_list" style={{ display: 'flex', flexDirection: 'row' }}>
                                                                ...
                                                                }} ><img src={this.state.pic5} style={{ maxHeight: 170 }} name="pic5" alt="" /> </li>
                                                            </ul>
                                                        </div>
                                                    }
                                                </div>
                                        ...
                                        <div className="row" style={{ backgroundColor: '#fff', padding: 20 }} >
                                            ...
                                            <div className="col-lg-9 col-12 order-3 order-lg-3" >
                                            
                                                <div className="order_info" style={{marginTop:0}} >
                                                <div className="product_description" style={{ textAlign: 'right' }}>
                                                    <div className="product_name YekanBakhFaBold" style={{ textAlign: 'right' }}>
                                                    <span style={{ borderBottom: "1px solid #eee" }}>{this.state.title}</span> <br /> <div style={{ fontSize: 14, marginTop: 15, color: '#b5b5b5' }}>{this.state.subtitle}</div></div>
                                                    <div style={{border:0}} className="mb-lg-0 mb-4">
                                                    
                                                                        <div className="product_text "><p className="YekanBakhFaBold" style={{  textAlign: 'right' }}><span className="fa fa-star " style={{ marginLeft: 5, color: "#f18517" }}></span>{this.state.ratingText}</p></div>
                                                                        <div className="product_text " style={{ marginTop: 0 }}><p className="YekanBakhFaBold" style={{  textAlign: 'right' }}><Rating value={this.state.rating} readonly={this.state.UId ? false : true} cancel={false} onChange={(e) => this.changeRating(e)}></Rating></p></div>
                                                ...
                                                </div>  
                                                    {
                                                            ...
                                                            <form action="#">
                                                                ...
                                                                {this.state.MainShopInfo.length > 0 &&
                                                                    <div style={{display:'flex',flexDirection:'row',justifyContent:'space-between',alignItems:'baseline'}}>
                                                                        ...
                                                                        <div className="product_text borderBottom" ><p className="YekanBakhFaBold" style={{ padding: "10px", textAlign: 'right' }}><i className="fal fa-shipping-fast" style={{ fontSize: 14, color: 'green', paddingLeft: 7 }}></i>آماده ارسال توسط <span style={{ color: '#333', fontSize: 20 }}>{this.state.MainShopInfo[0].name} </span></p></div>

                                                                        <div className="product_text borderBottom" ><p className="YekanBakhFaBold" style={{ padding: "10px", textAlign: 'right' }}><i className="fal fa-box-open" style={{ fontSize: 14, color: 'green', paddingLeft: 7 }}></i>{this.state.TitlesMap["existInStore"]}</p></div>
                                                                        {this.state.ProductBase ?
                                                                            <div className="product_text borderBottom" ><p className="YekanBakhFaBold" style={{ padding: "10px", textAlign: 'right' }}><i className="fal fa-rocket" style={{ fontSize: 14, color: 'green', paddingLeft: 7 }}></i>ارسال توسط <span style={{ color: '#333', fontSize: 20 }}>{this.state.MainShopInfo[0].name} </span>  تا <span style={{ color: '#333', fontSize: 20 }}>{this.state.PrepareTime || 3} </span>روز کاری دیگر</p></div>
                                                                            :
                                                                            <div className="product_text borderBottom" ><p className="YekanBakhFaBold" style={{ padding: "10px", textAlign: 'right' }}><i className="fal fa-rocket" style={{ fontSize: 14, color: 'green', paddingLeft: 7 }}></i>ارسال توسط <span style={{ color: '#333', fontSize: 20 }}>{this.state.MainShopInfo[0].name} </span>  تا <span style={{ color: '#333', fontSize: 20 }}>{this.state.PrepareTime || 30} </span> دقیقه پس از پرداخت </p></div>
                                                                        }
...

                                                                {
                                                                    (this.state.UId || !this.state.ShowPriceAftLogin) ?
                                                                        <div className="row" style={{ marginTop: 20,justifyContent:'center' }}>
                                                                            <div className="col-lg-4 col-12 " style={{ textAlign: 'center',display:'none' }}>
                                                                                <InputNumber value={this.state.reqNumber} inputStyle={{ borderRadius: 0, padding: 0, textAlign: 'center', fontSize: 20 }} mode="decimal" showButtons onValueChange={(e) => this.setState({ reqNumber: e.value })} min={1} max={this.state.number} />

                                                                            </div>
                                                                            <div className="col-lg-12 col-12 " style={{ textAlign: 'left' }}>
                                                                                {
                                                                                    ((!this.state.NoOff ? parseInt(this.props.off) : 0) + this.state.off) != "0" &&
                                                                                    <div className="mt-lg-0 mt-4">
                                                                            ...
                                                                            <div  className="col-lg-6 col-12 " style={{marginTop:20}}>

                                                                                    <Button type="button" style={{ display:'flex',justifyContent:'space-between',marginBottom: 10, paddingTop: 10, paddingBottom: 10, paddingRight: 10, paddingLeft: 10, width: '100%', background: '#ef394e', color: '#fff',borderRadius:50 }} className="iranyekanwebmedium" onClick={() => { this.SendToCart(this.state.id, this.state.ProductId, this.state.reqNumber, null, (this.roundPrice(this.state.price - ((this.state.price * ((!this.state.NoOff ? parseInt(this.props.off) : 0) + this.state.off)) / 100))), null, this.state.CatId) }}>
                                                                                        
                                                                                        <div style={{alignItems:'center' }} className="d-md-flex d-none">
                                                                                        <span style={{ float: 'right'}} ><i style={{ fontSize: 25 }} className="fal fa-shopping-cart" /></span>  <span style={{marginRight:20}}>خرید</span>
                                                                                        </div>
                                                                                        <div style={{width:'100%'}}>
                                                                                        {
                                                                                        ((!this.state.NoOff ? parseInt(this.props.off) : 0) + this.state.off) == "0" ?
                                                                                        <div className="product_price YekanBakhFaBold" style={{ textAlign: 'center', fontSize: 25 }}>{this.persianNumber(this.roundPrice(this.state.price.toString()).replace(/\B(?=(\d{3})+(?!\d))/g, ","))} تومان</div>
                                                                                                        
                                                                                        :
                                                                                            <div className="product_price YekanBakhFaBold" style={{ textAlign: 'center', fontSize: 25 }}>{this.persianNumber(this.roundPrice(parseInt(this.state.price - ((this.state.price * ((!this.state.NoOff ? parseInt(this.props.off) : 0) + this.state.off)) / 100)).toString()).replace(/\B(?=(\d{3})+(?!\d))/g, ","))} تومان</div>
                                                        ...
                                                        {this.state.Tags && (typeof this.state.Tags == "object") && this.state.Tags.length > 0 &&
                                                            <div style={{ marginTop: 20,textAlign:'right' }}>
                                                                <p className="iranyekanwebmedium" style={{ borderBottom: '1px solid #eee' }}>برچسب های محصول</p>
                                                                <div style={{ padding: 5, textAlign: 'right', borderRadius: 5, display: 'flex' }}>
                                                                    {this.state.Tags.map((v, i) => {
                                                                        return (
                                                                            <div style={{ marginLeft: 10 }} severity="info" >
                                                                                <Link to={`${process.env.PUBLIC_URL}/Tag?tag=${v._id}`} style={{ textDecoration: 'none', color: '#333' }}>
                                            ...
                                            <div className="col-lg-3 col-12 order-lg-1 order-2" >
                                                {(this.state.pic1 != "" && this.state.showSwipper ) ?
                                                    <Swiper {...params5} style={{ position: 'absolute' }}>
                                                        <div>
                                                            <img src={this.state.pic1} className="p-img" />
                                                        </div>
                                                        <div>
                                                            <img src={this.state.pic2} className="p-img" />
                                                        </div>
                                                        <div>
                                                            <img src={this.state.pic3} className="p-img" />
                                                        </div>
                                                        <div>
                                                            <img src={this.state.pic4} className="p-img" />
                                                        </div>
                                                        <div>
                                                            <img src={this.state.pic5} className="p-img" />
                                                        </div>
                                                    </Swiper>
                                                    :
                                                    <p style={{textAlign:'center'}}>
                                                ...
                                                {this.state.SellerName && this.state.IsSeveralShop &&
                                                        <div style={{display:'flex',flexDirection:'column',alignItems:'center'}} >
                                                            <div className="product_text " ><p className="YekanBakhFaBold" style={{ padding: "10px", textAlign: 'right' }}> {this.state.TitlesMap["shopTitle"]} : <Link to={`${process.env.PUBLIC_URL}/Shop?&name=${this.state.SellerName}&id=` + this.state.SellerId} className="title iranyekanwebmedium" ><span style={{ color: '#333', fontSize: 20 }}>{this.state.SellerName} </span></Link> </p></div>
                                                        </div>
                                                    }
                                                ...
                                                <div>
                                                    ...
                                                    <div>
                                                        ...
                                                        {this.state.SameData.map((item, index) => {
                                                            if (item.number > 0) {
                                                                var img = item.fileUploaded ? (this.state.absoluteUrl + item.fileUploaded.split("public")[1]) : null;
                                                                return (
                                                                    <div className="row" style={{ marginBottom: 10 }}>
                                                                        ...
                                                                        <div className="col-lg-3 col-md-6 col-12">
                                                                            <div className="car-title yekan" style={{ textAlign: 'right', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', fontSize: 14 }}>
                                                                                <span style={{ fontSize: 13, fontWeight: 'bold' }}><i className="fal fa-umbrella" style={{ fontSize: 20, color: '#000' }} /> {this.state.TitlesMap["guaranteeTitle"]}</span>
                                                                            </div>
                                                                        </div>
                                        ...
                                        <div style={{ marginTop: 30 }} className="row" >
                                            <div className="col-lg-12 col-12" >
                                                <TabView renderActiveOnly={false} style={{ textAlign: 'right', direction: 'rtl' }} activeIndex={0}  >
                                                    <TabPanel header="مشخصات" headerClassName="iranyekanwebmedium" righ_tIcon="fal fa-list">
                                                        {this.state.Spec &&
                                                            <div className="iranyekanwebmedium" style={{ padding: "10px", textAlign: 'right', marginTop: 20 }}>
                                                                <hr />
                                                                <div style={{ color: '#333', fontSize: 20 }}>مشخصات کالا</div>
                                                                ...
                                                                {typeof this.state.Spec == "object" && this.state.Spec.map((v, i) => {
                                                                    if (v.value && v.value != "-")
                                                                        return (<span className="iranyekanwebmedium" style={{ display: 'flex', flexDirection: 'row', margin: 5 }}><div className="YekanBakhFaBold" style={{ width: "30%", padding: 10 }}>{v.title}</div><div style={{ width: "5%" }}></div><div className="YekanBakhFaMedium" dangerouslySetInnerHTML={{ __html: v.value }} style={{ width: "65%", padding: 10, whiteSpace: 'pre-wrap' }}></div></span>)
                                                                })
                                                                }
                                                            </div>
                                                        }
                                                    </TabPanel>
                                                    <TabPanel header={this.state.TitlesMap["productReview"]} headerClassName="iranyekanwebmedium" righ_tIcon="fal fa-comments">
                                                        <p className="iranyekanwebmedium">{this.state.title}</p>
                                                        <p className="iranyekanwebmedium" style={{ whiteSpace: 'pre-line', fontSize: '1rem', lineHeight: "36px" }} >{this.state.review}</p>
                                                    </TabPanel>
                                                    <TabPanel header={this.state.TitlesMap["productSpReview"]} headerClassName="iranyekanwebmedium" righ_tIcon="fal fa-comments">
                                                        <p className="iranyekanwebmedium" >{this.state.title}</p>
                                                        <div className="specialReview" style={{ marginTop: 20 }} dangerouslySetInnerHTML={{ __html: this.state.specialReview }} ></div>

                                                    </TabPanel>
                                                    <TabPanel header="نظرات کاربران" headerClassName="iranyekanwebmedium" rig_htIcon="fal fa-comments">
                                                    ...
                                                    <TabPanel header="ثبت نظر" righ_tIcon="fal fa-comment-plus" headerClassName="iranyekanwebmedium" >

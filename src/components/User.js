...
class User extends React.Component {
  ...
  constructor(props) {
    ...
    this.itemTemplateForCancel = this.itemTemplateForCancel.bind(this);
            ...
            <div className="col-lg-12 col-md-6 col-12 YekanBakhFaLight" style={{ textAlign: 'right' }} >
              ...
              <div className="row" style={{ alignItems: 'center' }}>
                ...
                <div className="col-lg-4 col-12 YekanBakhFaMedium" style={{ textAlign: 'center', color: '#c7b800' }}>
                  <span>{this.state.Raymand ? "کسر از مهرکارت (ریال)" : "کسر از کیف پول"} : </span><span>{car.Credit}</span>
                  ...
                  return (
                    <div className="row" style={{ alignItems: 'baseline' }}>
                      ...
                      <div className="col-lg-3 col-md-3  col-12 YekanBakhFaMedium" style={{ textAlign: 'center' }}>
                        <Link target="_blank" to={`${process.env.PUBLIC_URL}/Products?id=` + v._id} >
          ...
          <div className="row" style={{ alignItems: 'center' }}>
            ...
            <div className="col-lg-12 col-md-6 col-12 YekanBakhFaLight" style={{ textAlign: 'right' }} >
              ...
              <div className="row" style={{ alignItems: 'center' }}>
                ...
                {car.Credit &&
                  <div className="col-lg-4 col-12 YekanBakhFaMedium" style={{ textAlign: 'right', marginBottom: 10 }}>
                    <span style={{ color: '#b5b5b5' }}>{this.state.Raymand ? "کسر از مهرکارت (ریال)" : "کسر از کیف پول"}  : </span><span style={{ fontSize: 17 }}>{car.Credit} تومان</span>
          ...
          <div className="row" style={{ alignItems: 'center' }}>
            ...
            <div className="col-lg-12 col-md-6 col-12 YekanBakhFaLight" style={{ textAlign: 'right' }} >
              ...
              <div className="row" style={{ alignItems: 'center' }}>
                ...
                <div className="col-lg-4 col-12 YekanBakhFaMedium" style={{ textAlign: 'right', marginBottom: 10 }}>
                  <span style={{ color: '#b5b5b5' }}>تاریخ ثبت : </span><div>{car.RegDate}</div>
                </div>
                <div className="col-lg-4 col-12 YekanBakhFaMedium" style={{ textAlign: 'right', marginBottom: 10 }}>
                  <span style={{ color: '#b5b5b5' }}>وام گیرنده: </span><div>{car.LaonName}</div>

                </div>
                <div className="col-lg-4 col-12 YekanBakhFaMedium" style={{ textAlign: 'right', marginBottom: 10 }}>
                  <span style={{ color: '#b5b5b5' }}>شماره حساب: </span><div>{car.LaonAcc}</div>

                </div>
                <div className="col-lg-4 col-12 YekanBakhFaMedium" style={{ textAlign: 'right', marginBottom: 10 }}>
                  <span style={{ color: '#b5b5b5' }}>شماره حساب: </span><div>{car.LaonMobile}</div>

                </div>


                <div className="col-lg-4 col-12 YekanBakhFaMedium" style={{ textAlign: 'right', marginBottom: 10 }}>
                  <span style={{ color: '#b5b5b5' }}>مبلغ درخواستی : </span><span style={{ fontSize: 17 }}>{car.LaonAmount} تومان</span>

                </div>
                  {car.needChange && car.status != 2 &&
                    <div className="col-lg-12 col-12 YekanBakhFaMedium" style={{ textAlign: 'right', marginBottom: 10,color:'red' }}>
                      <div style={{color:'red'}}>درخواست شما نیاز به اصلاح دارد</div>
                      <div style={{color:'red'}}>{car.desc}</div>
                    </div>
                ...
                {car.status == 1 &&
                  <div className="col-lg-12 col-12 YekanBakhFaMedium" style={{ textAlign: 'right', marginBottom: 10 }}>
                    <Button style={{ marginLeft: 5, marginTop: 10 }} color="primary" onClick={() => {
                      this.setState({
                        visibleLaonDialog: true,
                        selectedRow: car,
                        ChequeNember: Math.ceil(parseInt(car.LaonAmount) / 3000000)
        ...
        axios.post(this.state.url + 'getSettings', {
          ...
          .then(response => {
            this.setState({
              ...
              credit:(response.data.result.Raymand && that.props.credit) ? parseInt(that.props.credit.toString().substr(0,that.props.credit.toString().length-1)) : parseInt(that.props.credit)
  ...
  getUser() {
    ...
    let SCallBack = function (response) {
      that.setState({
        ...
        LaonName: response.data.result[0].name,
        LaonAcc: response.data.result[0].RaymandAcc,
  ...
  SetLaon() {
    ...
    if (!this.state.LaonAcc) {
      Alert.warning('شماره حساب را وارد کنید', 2500);
      return
    }
    if (!this.state.LaonAmount) {
      Alert.warning('مبلغ درخواستی را وارد کنید', 2500);
      return
    }
    that.setState({
      loading: 1
    ...
    let param = {
      token: localStorage.getItem("api_token"),
      LaonAmount: parseInt(this.state.LaonAmount),
    ...
    return (
      <div style={{ direction: 'rtl' }}>
        ...
        <div className="row justify-content-center firstInPage" style={{ minHeight: 600, marginTop: 50 }}>
            ...
            <div style={{ minHeight: 250, background: '#fff', borderRadius: 10, padding: 20, textAlign: 'right' }}>
              <ul>
                <li>            <img src='https://www.kalaoma.com/lib/themes/kalaoma/assets/test/avatar.png' style={{ width: 100, marginBottom: 30 }} />
                  ...
                  <p className="YekanBakhFaBold" style={{ fontSize: 17 }}>موجودی کیف پول : {this.state.credit.toString().replace(/,/g, "").replace(/\B(?=(\d{3})+(?!\d))/g, ",") } تومان</p>
                </li>
                ...
                {this.state.Raymand &&
                  <li style={{ cursor: 'pointer' }} onClick={() => { this.setState({ ActiveLi: 9 }); this.GetLaons(); }}><p className={this.state.ActiveLi == 9 ? 'YekanBakhFaBold side-active' : 'YekanBakhFaBold'} style={{ fontSize: 17 }} ><i className="fal fa-trash" style={{ marginLeft: 10, fontSize: 17 }}></i> پیگیری درخواست های وام</p> </li>
                }
                {this.state.Raymand &&
                  <li style={{ cursor: 'pointer' }} onClick={() => { this.setState({ ActiveLi: 10 }); }}><p className={this.state.ActiveLi == 10 ? 'YekanBakhFaBold side-active' : 'YekanBakhFaBold'} style={{ fontSize: 17 }} ><i className="fal fa-trash" style={{ marginLeft: 10, fontSize: 17 }}></i> درخواست وام</p> </li>
                }
          ...
          <div className={this.state.Theme != "2" ? "col-md-8 col-12 YekanBakhFaBold" : "col-md-9 col-12 YekanBakhFaBold"} style={{ dir: 'rtl' }} >
            {this.state.ActiveLi == 1 &&
              <div style={{ minHeight: 500, background: '#fff', borderRadius: 10, padding: 20, textAlign: 'right' }}>
                <ul style={{ display: 'flex', justifyContent: 'space-around' }}>
                  <li onClick={() => { this.setState({ FactorActiveLi: 1 }); this.GetFactors(['1']) }} style={{ cursor: 'pointer' }} className={this.state.FactorActiveLi == 1 ? 'YekanBakhFaBold btn-active' : 'YekanBakhFaBold'} ><span className='YekanBakhFaBold'>در حال پردازش</span></li>
                  <li onClick={() => { this.setState({ FactorActiveLi: 2 }); this.GetFactors(['2']) }} style={{ cursor: 'pointer' }} className={this.state.FactorActiveLi == 2 ? 'YekanBakhFaBold btn-active' : 'YekanBakhFaBold'} ><span className='YekanBakhFaBold' >آماده ارسال</span></li>
                  <li onClick={() => { this.setState({ FactorActiveLi: 3 }); this.GetFactors(['3']) }} style={{ cursor: 'pointer' }} className={this.state.FactorActiveLi == 3 ? 'YekanBakhFaBold btn-active' : 'YekanBakhFaBold'} ><span className='YekanBakhFaBold '>ارسال شده</span></li>
                  <li onClick={() => { this.setState({ FactorActiveLi: 4 }); this.GetFactors(['4', '5']) }} style={{ cursor: 'pointer' }} className={this.state.FactorActiveLi == 4 ? 'YekanBakhFaBold btn-active' : 'YekanBakhFaBold'} ><span className='YekanBakhFaBold' >تحویل شده</span></li>
                </ul>
            ...
            {this.state.ActiveLi == 2 &&
              ...
              <div style={{ minHeight: 500, background: '#fff', borderRadius: 10, padding: 20, textAlign: 'right' }}>
                <ul style={{ display: 'flex', justifyContent: 'space-around' }}>
                  <li onClick={() => { this.setState({ PayActiveLi: 1 }); this.GetPayment(1) }} style={{ cursor: 'pointer' }} ><span className={this.state.PayActiveLi == 1 ? 'YekanBakhFaBold btn-active' : 'YekanBakhFaBold'}>تراکنش های موفق</span></li>
                  <li onClick={() => { this.setState({ PayActiveLi: 2 }); this.GetPayment(0) }} style={{ cursor: 'pointer' }} ><span className={this.state.PayActiveLi == 2 ? 'YekanBakhFaBold btn-active' : 'YekanBakhFaBold'}>تراکنش های ناموفق</span></li>
                </ul>
            ...
            {this.state.ActiveLi == 10 &&

              <div className="row" style={{ background: '#fff', borderRadius: 10, padding: 20, textAlign: 'right', alignItems: 'baseline' }}>
                <div className="col-lg-6">
                  <div className="group">
                    <input className="form-control YekanBakhFaBold" autoComplete="off" type="text" value={this.state.LaonAcc} name="LaonAcc" onChange={(event) => this.setState({ LaonAcc: event.target.value })} style={{ textAlign: 'right' }} required="true" />
                    <label>شماره حساب صندوق</label>
                  </div>
                </div>
                <div className="col-lg-6">
                  <div className="group">
                    <input className="form-control YekanBakhFaBold" autoComplete="off" type="text" value={this.state.LaonMobile} name="LaonMobile" onChange={(event) => this.setState({ LaonMobile: event.target.value })} style={{ textAlign: 'right' }} required="true" />
                ...
                <div className="col-lg-6">
                  <a href="#" >افتتاح حساب</a>
                </div>
                <div className="col-lg-12">
                  <div className="group">
                    <input className="form-control YekanBakhFaBold" autoComplete="off" type="text" value={this.state.LaonName} name="LaonName" onChange={(event) => this.setState({ LaonName: event.target.value })} style={{ textAlign: 'right' }} required="true" />
                    <label>نام و نام خانوادگی</label>
                  </div>
                </div>
                ...
                <div className="col-lg-12">
                  <div className="group">
                    <input className="form-control YekanBakhFaBold" autoComplete="off" type="text" value={this.state.LaonAmount} name="LaonAmount" onChange={(event) => {
                      this.setState({ LaonAmount: event.target.value })
                    }

                    } style={{ textAlign: 'right' }} required="true" />
                ...
                <div className="col-lg-12" style={{ textAlign: 'right' }}>
                  <Button style={{ marginLeft: 5, marginTop: 10 }} color="primary" onClick={() => this.SetLaon()}>ثبت درخواست</Button>
            ...
            <Dialog header="بارگزاری مدارک" visible={this.state.visibleLaonDialog}  maximized={true} onHide={() => {
              ...
              <div>
                ...
                <div style={{textAlign:'center',marginTop:50,marginBottom:50}}>
                  <button className="btn btn-info YekanBakhFaMedium" onClick={() => this.EditLaon()}>ثبت مدارک</button>
                  ...
                  {this.state.selectedRow && this.state.selectedRow.ChequeList && this.state.selectedRow.ChequeList.map((item,index)=>{
                    return(
                      <div className="row" style={{alignItems:'center',backgroundColor:"aliceblue"}}>
                        <div className="col-2">
                          <label>{item.InChequeNumber}</label>
                        </div>
                        <div className="col-2">
                          <label>{item.InChequeName}</label>
                        </div>
                        <div className="col-2">
                          <label>{item.InChequeDate}</label>
                        </div>
                        
                        <div className="col-3">
                          <label>{item.InChequeAmount}</label>
                        </div>
                        <div className="col-3">

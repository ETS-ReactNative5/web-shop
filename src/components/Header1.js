	...
	render() {
		...
		return (
			<div style={{ background: '#fff', paddingBottom: 10 }}>
					<div style={{height:35,padding:5,backgroundSize:'auto 100%',backgroundPosition:'50%',backgroundImage:'url(https://dkstatics-public.digikala.com/digikala-adservice-banners/9521d61d337456b9c498ea05c7f54d76981faa19_1609858694.gif)'}} >
					</div>
				<div >

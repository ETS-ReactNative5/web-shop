      ...
      <div style={{ direction: 'rtl' }}>
        ...
        <div className="row justify-content-center mt-5">
          ...
          <div className="col-12" style={{ textAlign: 'right' }}>
            ...
            <Panel header="انتخاب کیف پول" style={{  textAlign: 'right', fontFamily: 'yekan' }}>
            ...
            <Panel header="انتخاب فروشگاه" style={{ marginTop: 20, textAlign: 'right', marginBottom: 50, fontFamily: 'yekan' }}>
              <Dropdown value={this.state.ShopId} panelStyle={{ textAlign: 'right' }} style={{ fontFamily: 'iranyekanwebregular', width: '100%', textAlign: 'right', marginTop: 20 }} options={this.state.ShopArrayOption} onChange={(event) => this.setState({
            ...
            <Panel header="کسر سود " style={{ marginTop: 20, textAlign: 'right', marginBottom: 50, fontFamily: 'yekan' }}>
              <div className="group">
            ...
            <Panel header="تسویه حساب فروشگاههای طرف قرارداد " style={{ marginTop: 20, textAlign: 'right', marginBottom: 50, fontFamily: 'yekan' }}>

...
class Canceled_Products extends React.Component {
  constructor(props) {
    super(props);
      ...
      <div style={{ direction: 'rtl' }}>
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-12" style={{ marginTop: 20, backgroundColor: '#fff' }}>
            ...
            <div className="section-title " style={{ textAlign: 'right' }}><span className="title IRANYekan" style={{ fontSize: 17, color: 'gray' }} > لیست فاکتورهای با محصول مرجوع شده</span></div>
...
export default withRouter(
  connect(mapStateToProps)(Canceled_Products)
);

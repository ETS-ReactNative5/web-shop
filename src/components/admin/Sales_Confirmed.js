...
class Sales_Confirmed extends React.Component {
  constructor(props) {
    super(props);
      ...
      <div style={{ direction: 'rtl' }}>
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-12" style={{ marginTop: 20, backgroundColor: '#fff' }}>
            ...
            <div className="section-title " style={{ textAlign: 'right' }}><span className="title IRANYekan" style={{ fontSize: 17, color: 'gray' }} >لیست فاکتورها (تایید شده)</span></div>
...
export default withRouter(
  connect(mapStateToProps)(Sales_Confirmed)
);

...
class AdminProduct extends React.Component {
  constructor(props) {
    ...
    this.handleChangeReview_edit = this.handleChangeReview_edit.bind(this);
  ...
  getMainShopInfo() {
    ...
    let ECallBack = function (error) {
      ...
      //that.GetProduct();
      if(that.state.selectedCatId){
        that.GetProductsOfCategory(that.state.selectedCatId)

      }
      if(that.state.selectedTagId){
        that.GetProductsOfTag(that.state.selectedTagId)
      }
  ...
  onHide(event) {
    ...
    if (this.state.selectedCatId) {
      ...
      this.GetProductsOfCategory(this.state.selectedCatId);
      ...
      this.GetProductsOfTag(this.state.selectedTagId);
    ...
    if (this.state.CatSpecs_Edit) {
      for (let i = 0; i < this.state.CatSpecs_Edit.length; i++) {
        this.setState({ ["Spec_edit_" + this.state.CatSpecs_Edit[i].id]: ""})
  ...
  handleChangeReview_edit(event) {
    this.setState({ review_edit: event.target.value });
  }
    ...
    that.Server.send("AdminApi/getSettings", {}, function (response) {
      ...
      if (response.data.result) {
        ...
        that.setState({
          ...
          Theme: response.data.result[0].Theme ? response.data.result[0].Theme : 1
        })
          ...
          <div className="col-lg-12 " >
            <div className="row" style={{ margin: 20 }}>
              ...
              <div className="col-lg-7 col-12 yekan" style={{ textAlign: "center" }}>
                ...
                {car.code &&
                  <p className="yekan" ><span>کد کالا :</span> <span>{car.code}</span></p>
                }
                {car.chap &&
                  <p className="yekan" ><span>چاپ :</span> <span>{car.chap}</span></p>
                }
  ...
  PreparEditProduct(row) {
    ...
    this.setState({
      ...
      ShopId_product_edit: ShopArraySelected[ShopArraySelected.length - 1] || "",
    ...
    else if (ShopArraySelected[0]) {
      this.GetProductPerShop(ShopArraySelected[ShopArraySelected.length - 1], row._id);
  ...
  deletePic(name){
    let that = this;
    confirmAlert({
      title: <span className="yekan">حذف تصویر</span>,
      message: <div>
        <span className="yekan"> آیا از حذف تصویر اطمینان دارید ؟  </span>
      </div>,
      buttons: [
        {
            ...
            let SCallBack = function (response1) {
              that.Server.send("AdminApi/RemPics", {
                ...
                , function (response) {
                  ...
                  let nophoto = that.state.absoluteUrl + 'nophoto.png';
                  let state = {
                    loading: 0
                  }
                  if(name=="fileUploaded")
                    state["pic1"] = nophoto;
                  if(name=="fileUploaded1")
                    state["pic2"] = nophoto;
                  if(name=="fileUploaded2")
                    state["pic3"] = nophoto;
                  if(name=="fileUploaded3")
                    state["pic4"] = nophoto;
                  if(name=="fileUploaded4")
                    state["pic5"] = nophoto;
                  that.setState(state)
  ...
  setProduct(event) {
    ...
    let param = {
      ...
      specialReview: this.state.specialReview,
      price: parseInt(this.state.price.replace(/,/g, "")),
      off: this.state.off,
  ...
  editProduct(event) {
    ...
    if ((this.state.ShopId_product_edit == "" && this.state.SeveralShop && this.state.SellerId == this.state.MainShopId)) {
      Alert.success(""+this.state.TitlesMap["shopTitle"]+" را انتخاب کنید", 2500);
    ...
    let param = {
      ...
      review: this.state.review_edit,
      specialReview: this.state.specialReview_edit,
      price: parseInt(this.state.price_edit.replace(/,/g, "")),
  ...
  onSelect(event) {
    var _id = event.originalEvent.currentTarget.getElementsByClassName("row")[0].getAttribute("_id") /*event.originalEvent.target.getAttribute("_id")*/;
    var _catId = event.originalEvent.currentTarget.getElementsByClassName("row")[0].getAttribute("_catId")/*event.originalEvent.target.getAttribute("_catId")*/;
    var _tagId = event.originalEvent.currentTarget.getElementsByClassName("row")[0].getAttribute("_tagId")/*event.originalEvent.target.getAttribute("_tagId")*/;
    this.setState({
    ...
    return (
      ...
      <div>
        {this.state.loading == 1 &&
          <div style={{ position: 'fixed', zIndex: 2000, top: 10, left: 15, backgroundColor: '#e89f31', padding: '2px 20px',textAlign:'center',width:'100%' }}>
            <Loader content="لطفا صبر کنید ..." className="yekan" />
          </div>
        }
        {this.state.showLoadedCount > 0 &&
          <div style={{ position: 'fixed', zIndex: 2000, top: 10, left: 15, backgroundColor: '#e89f31', padding: '2px 20px', direction: 'ltr',textAlign:'center',width:'100%' }}>
            ...
            {this.state.SellerId && this.state.MainShopId && this.state.SellerId == this.state.MainShopId &&
              <div className="col-lg-7 col-md-12 col-12" >
                ...
                <form onSubmit={this.setProduct} >
                  <div className="group">
                    <AutoComplete placeholder={this.state.TitlesMap["productTitle"]} inputStyle={{ fontFamily: 'iranyekanwebregular', textAlign: 'right', fontSize: 16, padding: 7 }} style={{ width: '100%' }} onChange={(e) => this.setState({ title: e.value })} itemTemplate={this.itemTemplateTitle.bind(this)} value={this.state.title} onSelect={(e) => this.onSelectTitle(e)} suggestions={this.state.TitleSuggestions} completeMethod={this.suggestTitle.bind(this)} />
                  ...
                  <div className="group">
                    ...
                    <label>{this.state.TitlesMap["productSubTitle"]}</label>
                  </div>
                  <div className="group">
                    ...
                    <label>{this.state.TitlesMap["productDesc"]}</label>
                  </div>
                  <div className="group">
                    <textarea className="form-control yekan" style={{ height: 250 }} autoComplete="off" type="text" value={this.state.review} name="review" onChange={this.handleChangeReview} required="true" />
                    <label>{this.state.TitlesMap["productReview"]}</label>
                  </div>
                  <div style={{ direction: 'rtl', textAlign: 'right' }}>
                    <label className="yekan">{this.state.TitlesMap["productSpReview"]}</label>

                    <JoditEditor
                      value={this.state.specialReview}
                      config={config}
                      tabIndex={1} // tabIndex of textarea
                      onChange={(value) => {
                        this.setState({ specialReview: value })
                      }}
                      minHeight={400}
                    />
                  </div>
                    ...
                    <div>
                      ...
                      <div>
                        ...
                        <div style={{ textAlign: 'center' }}>
                          ...
                          })} optionLabel="name" placeholder={this.state.TitlesMap["shopTitle"]}
                  ...
                  <div style={{ display: (this.state.UploadBoxToggle ? "flex" : "none") }} className="row">
                    <div className="col-12" style={{ display: 'flex',alignItems:'baseline' }}>
                      ...
                      {this.state.fileUploaded &&
                        <div style={{ width: "20%" }}>
                          <img src={this.state.absoluteUrl + this.state.fileUploaded.split("public")[1]} />
                        </div>
                      }
                    </div>
                    <div className="col-12" style={{ display: 'flex',alignItems:'baseline' }}>
                      ...
                      {this.state.fileUploaded1 &&
                        <div style={{ width: "20%" }}>
                          <img src={this.state.absoluteUrl + this.state.fileUploaded1.split("public")[1]} />
                        </div>
                      }
                    </div>
                    <div className="col-12" style={{ display: 'flex',alignItems:'baseline' }}>
                      ...
                      {this.state.fileUploaded2 &&
                        <div style={{ width: "20%" }}>
                          <img src={this.state.absoluteUrl + this.state.fileUploaded2.split("public")[1]} />
                        </div>
                      }
                    </div>
                    <div className="col-12" style={{ display: 'flex',alignItems:'baseline' }}>
                      ...
                      {this.state.fileUploaded3 &&
                        <div style={{ width: "20%" }}>
                          <img src={this.state.absoluteUrl + this.state.fileUploaded3.split("public")[1]} />
                        </div>
                      }
                    </div>
                    <div className="col-12" style={{ display: 'flex',alignItems:'baseline' }}>
                      ...
                      {this.state.fileUploaded4 &&
                        <div style={{ width: "20%" }}>
                          <img src={this.state.absoluteUrl + this.state.fileUploaded4.split("public")[1]} />
                        </div>
                      }
                    </div>
                  </div>
          ...
          <div className="AdminProduct">
            <TabView activeIndex={this.state.activeIndex} onTabChange={(e) => { this.setState({ activeIndex: e.index }); if (e.index == 1) { this.GetProductsOfCategory(this.state.ShopCats) } }}>
              ...
              <TabPanel header="فروشنده شوید">
                ...
                <p style={{ fontFamily: 'YekanBakhFaBold', textAlign: 'right' }}>محصولات لیست زیر بر اساس دسته بندی های ثبت شده برای {this.state.TitlesMap["shopTitle"]} شما مرتب شده اند</p>
                <hr />
            ...
            <div className="row">
                  ...
                  <div className="row" style={{ alignItems: 'baseline' }}>
                    <div className="col-lg-10 col-12">
                      ...
                      <div className="group" style={{ textAlign: 'center' }}>
                        ...
                        } optionLabel="name" placeholder={this.state.TitlesMap[5]}
                          valueTemplate={this.selectedShopTemplate} filter filterBy="name" itemTemplate={this.ShopOptionTemplate} />
              ...
              <div className="col-lg-6">
                <div className="group">
                  ...
                  <label>{this.state.TitlesMap["productTitle"]}</label>
                </div>
              </div>
              <div className="col-lg-6">
              ...
              <div className="col-lg-12">
                <div className="group">
                  <textarea className="form-control yekan" autoComplete="off" style={{ height: 220 }} type="text" value={this.state.review_edit} name="review_edit" onChange={this.handleChangeReview_edit} required="true" disabled={this.state.SellerId != this.state.MainShopId} />
                  <label>{this.state.TitlesMap["productReview"]}</label>
                </div>
              </div>
              <div className="col-lg-12">
                <div style={{ direction: 'rtl', textAlign: 'right' }}>
                  ...
                  <JoditEditor
                    value={this.state.specialReview_edit}
                    config={config}
                    tabIndex={1} // tabIndex of textarea
                    onChange={(value) => {
                      this.setState({ specialReview_edit: value })
                    }}
                    minHeight={400}
                  />
                </div>
                              ...
                              return (<div className="col-6" >
                                <div className="group">
                                  <input className="form-control yekan" autoComplete="off" type="text" value={this.state[v.Etitle + "_edit"][j].priceChange} onChange={(event) => {
                                    ...
                                    temp[j].priceChange = event.target.value;
                                    this.setState({ [v.Etitle + "_edit"]: temp })
                                  }} required="true" />
                                  <label>اختلاف قیمت رنگ {u.desc} (تومان)</label>
                                </div>
                              </div>
        ...
        <Dialog header="تصاویر" visible={this.state.visibleModalPic} onHide={this.onHide} maximizable={true}>
          ...
          <div className="row" >
            <div className="col-6" >
              ...
              <div style={{textAlign:'center'}} onClick={()=>this.deletePic("fileUploaded")}>
          ...
          <div className="row" >
            <div className="col-3" >
              ...
              <div style={{textAlign:'center'}} onClick={()=>this.deletePic("fileUploaded1")}>
              <i className="fa fa-trash" style={{cursor:'pointer',color:'red'}}  />
                </div>
            ...
            <div className="col-3" >
              ...
              <div style={{textAlign:'center'}} onClick={()=>this.deletePic("fileUploaded2")}>
              <i className="fa fa-trash" style={{cursor:'pointer',color:'red'}}  />
                </div>
            ...
            <div className="col-3" >
              ...
              <div style={{textAlign:'center'}} onClick={()=>this.deletePic("fileUploaded3")}>
              <i className="fa fa-trash" style={{cursor:'pointer',color:'red'}}  />
                </div>
            ...
            <div className="col-3" >
              ...
              <div style={{textAlign:'center'}} onClick={()=>this.deletePic("fileUploaded4")}>
              <i className="fa fa-trash" style={{cursor:'pointer',color:'red'}}  />
                </div>

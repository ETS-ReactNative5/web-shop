				...
				<div className="row justify-content-center" style={{ marginRight: 15, marginLeft: 15 }} >
					{this.state.ShopList.data && this.state.ShopList.data.length > 0 &&
						<div className="col-lg-12 col-md-12 col-12" style={{ direction: 'rtl', backgroundColor: '#fff', borderRadius: 10 }}>
							<div className="section-title " style={{ marginLeft: 10, marginRight: 10, textAlign: 'right' }}><span className="title iranyekanwebmedium" style={{ fontSize: 16, color: 'gray' }} >‍‍‍‍‍‍‍سایر محصولات فروشگاه {this.props.name} </span> <Link to={`${process.env.PUBLIC_URL}/Shops?&name=${this.props.name}&id=` + this.props._id} className="title iranyekanwebmedium" style={{ fontSize: 13, float: 'left', color: '#000', textDecoration: 'none' }}>   مشاهده محصولات بیشتر  ...</Link></div>
							<Swiper {...params}>

			...
			<div className={this.props.Class}>
				{this.state.link && this.state.link.indexOf("http") > -1 ?
					<a href={this.state.link6} href="#" target="_blank" style={{ textDecoration: 'none' }}>
						{this.state.text &&
							<p className="iranyekanwebmedium  p-md-2 , p-0" style={{ margin: 0, position: 'absolute', zIndex: 2, fontSize: 15, color: 'rgb(255 248 42)', backgroundColor: 'rgb(0 0 10 / 63%)', paddingBottom: 5, width: '100%', textAlign: 'right', boxShadow: 'rgb(185 185 185) 10px 10px 15px', bottom: 0, right: 10 }}>{this.state.text}</p>
						}

        ...
        return (
 			 <footer className="footer-area" style={{marginTop:20,paddingTop:40,paddingBottom:0}}>
				...
				<div style={{background:'#505050'}}>
					...
					<div style={{textAlign:'center'}}>
						{this.props.System == "company" ?
							<p style={{margin:0}} className="yekan">استفاده از مطالب وبسایت اینترنتی {this.state.GridInfo[0].name} فقط برای مقاصد غیرتجاری و با ذکر منبع بلامانع است. کلیه حقوق این سایت متعلق به {this.state.GridInfo[0].name} می‌باشد.</p>
						:
					...
					<div style={{textAlign:'center',paddingBottom:10}}>
							<p style={{margin:0}} className="yekan">طراحی و پیاده سازی توسط <a href="http://sarvapps.ir" target="_blank" style={{color:'#a9a9a9'}}>داده پرداز سرو آرا</a></p>
					</div>
				</div>
			</footer>

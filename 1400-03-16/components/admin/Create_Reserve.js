...
class Create_Reserve extends React.Component {
  ...
  SetReserve() {
    ...
    for(let i=0;i<this.state.Keys.length;i++){
      TableRecords.push({
        ...
        username: this.state.TableRecords["username_"+this.state.Keys[i]]||false,
        name: this.state.TableRecords["name_"+this.state.Keys[i]]||false,
        account: this.state.TableRecords["account_"+this.state.Keys[i]]||false,
        mobile: this.state.TableRecords["mobile_"+this.state.Keys[i]]||false,
  ...
  selectedComponentChange(value) {
    ...
    this.setState(p)
    this.GetReserveDetails(value.number);
  ...
  GetReserve() {
    ...
    let SCallBack = function (response) {
      ...
      that.setState({
        ...
        pic1: that.state.absoluteUrl + response.data.result[0].pic?.split("public")[1],
        extraPic1: that.state.absoluteUrl + response.data.result[0].extraPic1?.split("public")[1],
        extraPic2: that.state.absoluteUrl + response.data.result[0].extraPic2?.split("public")[1],
        extraPic3: that.state.absoluteUrl + response.data.result[0].extraPic3?.split("public")[1],
        extraPic4: that.state.absoluteUrl + response.data.result[0].extraPic4?.split("public")[1]
